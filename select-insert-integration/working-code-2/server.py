...
def structured_insert(
    ...
    Args:
        ...
        conflict_target: List of columns to target for ON CONFLICT clause (must match a unique constraint). Required if on_conflict is 'update'.
        update_columns_on_conflict: List of columns to update in case of conflict. If None, updates all inserted columns.
    ...
    """
    try:
        return mcp_insert_tool(table, data, on_conflict, conflict_target, update_columns_on_conflict, returning, DB_CONFIG)
